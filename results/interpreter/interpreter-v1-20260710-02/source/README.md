...
The recorded run `interpreter-v1-20260710-01` passed its independent audit:
37,506 rows comprising 25,464 per-gate records, 12,035 successful run records,
and seven fail-closed negative controls. It covers 100 fixed-seed random DAGs,
a 512-gate boundary chain, a zero-gate descriptor, 10,000 alternating
invocations, and `GATE_CAP=64`, sentinel, and explicit-logic controls. The
alternation is serial state-reset/regression evidence, not a concurrency
