...
the long-form `PAPER_DRAFT.md` and the LangSec report
`PAPER_LANGSEC_REPORT.md` (IEEE source: `PAPER_LANGSEC_REPORT.tex`), plus a
numeric precision-control experiment. It is
intended for an isolated Linux VM with root access and BTF enabled.

## What this establishes

Full scope is in `ARTIFACT.md`. In the LangSec report's claim graph, the direct
...
The report-bound run `interpreter-langsec-20260711-02` passed its separate
...
The LangSec report distinguishes the accepted artifact language `L_V`,
