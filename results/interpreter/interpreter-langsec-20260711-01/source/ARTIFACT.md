...
- `make interpreter-data`: a fresh `results/interpreter/<run-id>/` with a
  ...
  `interpreter-langsec-20260711-01` run has 38,533 JSONL rows: 26,488 per-gate
...
The long formal development is in `PAPER_DRAFT.md`; the LangSec claim graph
and calibration report are in `PAPER_LANGSEC_REPORT.md`; the legacy artifact
